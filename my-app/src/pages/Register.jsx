...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(registerUser({ username, password, confirmPassword, admin: isAdmin }));
  };

  return (
    <div className="d-flex justify-content-center align-items-center min-vh-100 bg-light">
      <div className="card shadow-sm border-0 p-4" style={{ width: '100%', maxWidth: '400px', borderRadius: '8px' }}>
        <h2 className="text-center fw-bold mb-4 text-dark fs-3">Register</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="confirmPassword" className="form-label text-secondary fw-semibold mb-1" style={{ fontSize: '0.9rem' }}>
              Confirm Password
            </label>
            <input
              type={showPassword ? 'text' : 'password'}
        ...
        <div className="text-center mt-2">
          <Link to="/login" className="text-primary text-decoration-none" style={{ fontSize: '0.9rem' }}>
